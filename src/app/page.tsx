...
export default function Home() {
  return (
    ...
    <h2 className="m-4 font-bold font-mono text-orange-500">O MNIE</h2>
    ...
    <h2 className="m-4 font-bold font-mono text-orange-500">OFERTA</h2>
    <h3 className="m-4 font-bold font-mono text-gray-500 bg-yellow-200">Psychoterapia</h3>
    ...
    <div className="container lg:flex lg:space-x-4 m-4 p-4 font-mono text-justify">
      ...
      <h2 className="m-4 font-bold font-mono text-gray-500 bg-yellow-200">Warsztaty</h2>
    ...
    <h2 className="m-4 font-bold font-mono text-orange-500">BLOG</h2>
    ...
    <h2 className="m-4 font-bold font-mono text-orange-500">KONTAKT</h2>
    <div className="prose prose-base m-4 text-justify font-mono border-dotted border-2 border-orange-500 p-4">
      <p>tel. 665 696 372</p>
